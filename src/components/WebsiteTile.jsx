...
import NEXT_JS_WEDDING_DAYS from '../Assets/Wedding-Days.PNG'
    ...
    <div className="skills">
      ...
      >
        {itemData.map((item) => {
          ...
          return (
            <ImageListItem key={item.img} cols={cols} rows={rows} onClick={() => window.open(item.url)}>
              <img
...
const itemData = [
  {
    img: NEXT_JS_WEDDING_DAYS,
    title: 'NEXT.JS PROJECT',
    url: 'https://wedding-days.vercel.app/',
    author: '@clinto92',
    featured: true,
  },
  {

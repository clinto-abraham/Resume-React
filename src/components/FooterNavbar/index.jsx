...
//     FavoriteIcon, RestoreIcon, LocationOnIcon, GitHubIcon, LinkedInIcon, TwitterIcon, LightbulbIcon, GavelIcon, PolicyIcon, StarsIcon, AccountTreeIcon, LayersIcon, ThumbUpIcon, CommentIcon, HomeIcon, useDispatch,
//     PropTypes,
// } from '../../utils/exports'
...
//             > */}
//             <Button sx={{ justifyContent: "flex-start", margin: '0.2rem 4.5rem', }} variant={'text'} fullWidth>
//                 {Icons[index]}
//                 <Typography sx={{ margin: '0.5rem 1rem', textDecorationLine: 'none', color: 'white' }}>
//                     {name}
//                 </Typography>
//             </Button>
//             {/* </Link> */}
...
//     return (
//         <>
//             <Grid container sx={{ padding: '1rem', margin: '0rem', backgroundColor: 'black', color: 'white', textDecoration: 'none', display: 'flex', justifyContent: 'left' }}>
...
//                             <Typography align='center' sx={{ margin: '0.2rem 0rem', color: 'white' }}>Developed by Clinto Abraham A.</Typography>
//                             <Typography align='center' sx={{ margin: '0.2rem 0rem', color: 'white' }}>Powered by - Top Of Cliff</Typography>
//                             <Typography align='center' sx={{ margin: '0.2rem 0rem', color: 'white' }}> @ 2020 - {currentYear}</Typography>

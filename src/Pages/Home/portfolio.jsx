          ...
          <div className="row">
            ...
            <div className="col-1-of-2">
              <div className="composition">
                <img
                  // srcset="nat-1.jpg 300w, img/nat-1-large.jpg 1000w"
                ...
                <img
                  // srcset="nat-2.jpg 300w, img/nat-2-large.jpg 1000w"
                  sizes="(max-width: 56.25em) 20vw, (max-width: 37.5em) 30vw, 300px"
                  alt="Photo 2"
                ...
                <img
                  // srcset="nat-3.jpg 300w, img/nat-3-large.jpg 1000w"
                  sizes="(max-width: 56.25em) 20vw, (max-width: 37.5em) 30vw, 300px"
                  alt="Photo 3"
      ...
      <footer className="footer">
        <div className="footer__logo-box">
          <picture className="footer__logo">
            <source
              // srcset="logo-green-small-1x.png 1x, img/logo-green-small-2x.png 2x"
              media="(max-width: 37.5em)"
            />
            <img
              // srcset="logo-green-1x.png 1x, img/logo-green-2x.png 2x"
              alt="Full logo"
